...
//-------------------------------------------------------------------------	
		...
		//$genre_clean = ereg_replace("[^A-Za-zñÑáéíóúÁÉÍÓÚ@\&nbsp;]", "&nbsp;", $clean_genre);
		...
		echo "<b class='title' >Año:</b>&nbsp;&nbsp;<input type=text id='year_data' name='year' readonly='readonly' value='".trim($clean_year)."'/>";
		//year
